...
//        System.out.println(new D100Roll().d100FromRoll("96", "15", "98", "10")); //111
    ...
    public void run(String... args) throws Exception {
        if (playerRepository.count() == 0) {
            ...
            playerRepository.save(new Player("NJK06", "Ork Archer", Gender.male, Race.orc, PlayerClass.archer, 1, 34d, 0, 28, 10, 43, -25, -25, 0, 15, false, 10, 10, 10, ArmorType.heavyLeather, 5, 5, 5, 5, -25, -25, 5, 5));
            playerRepository.save(new Player("NJK07", "Ork Archer", Gender.male, Race.orc, PlayerClass.archer, 2, 47d, 5, 36, 41, 56, -25, -25, 0, 15, false, 10, 10, 10, ArmorType.heavyLeather, 5, 5, 5, 5, -25, -25, 5, 5));
            playerRepository.save(new Player("NJK08", "Ork Archer", Gender.male, Race.orc, PlayerClass.archer, 2, 47d, 5, 36, 41, 56, -25, -25, 0, 15, false, 10, 10, 10, ArmorType.heavyLeather, 5, 5, 5, 5, -25, -25, 5, 5));
            playerRepository.save(new Player("NJK09", "Ork Archer", Gender.male, Race.orc, PlayerClass.archer, 3, 60d, 10, 44, 49, 69, -25, -25, 0, 15, false, 10, 10, 10, ArmorType.heavyLeather, 5, 5, 5, 5, -25, -25, 5, 5));
            playerRepository.save(new Player("NJK10", "Ork Archer", Gender.male, Race.orc, PlayerClass.archer, 3, 60d, 10, 44, 49, 69, -25, -25, 0, 15, false, 10, 10, 10, ArmorType.heavyLeather, 5, 5, 5, 5, -25, -25, 5, 5));
